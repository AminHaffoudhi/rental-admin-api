...
const STORAGE_AUTH_HINT =
  "Check MINIO_ACCESS_KEY and MINIO_SECRET_KEY in rental-admin-api/.env — copy the same values as rental-api/.env (often MINIO_ROOT_USER / MINIO_ROOT_PASSWORD from docker).";
...
export type UploadFolder = "equipment" | "avatars" | "kyc" | "delivery" | "categories";
